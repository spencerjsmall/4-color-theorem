...
example isFourColorable3 is {some g: Graph | wellformed[g] and canFourColor[g]} for {
    #Int = 5
...
example K4is4Colorable is {some g: Graph | wellformed[g] and canFourColor[g]} for {
    #Int = 5
